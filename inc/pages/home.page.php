...
<!-- Info -->
<div id="first-content" class="border-top-3" style="background-color: rgba(255, 255, 255, 1); min-height: 400px">
	<?php include INC_PATH . 'front-page-info.php'; ?>
</div>

<!-- Carousel -->
<div class="border-top-3" style="height: 800px; padding-left: 0; padding-right: 0;">
...
<!-- FAQ -->
<div class="border-top-3" style="background-color: rgba(0, 0, 0, 0.6); min-height: 400px;">
