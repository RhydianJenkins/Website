    ...
    <div class="row">
        <div class="col-md-4" style="padding-bottom: 20px;">
            ...
            <div class="text-center" style="width: 100%;">
                <img class="img-circle fill info-img" src="http://placehold.it/250x250" />
            </div>
        ...
        <div class="col-md-4" style="padding-bottom: 20px;">
            ...
            <p>The lake is open for windsurfing on Sundays only from October to mid March;  in the Spring and Summer we’re also open on Saturdays and Tuesday and Wednesday evenings (see club booklet).</p>
            <p>It's important that you hold the combination lock closed and spin the numerals when entering or exiting the reservoir outer gate.</p>
        </div>
        <div class="col-md-4" style="padding-bottom: 20px;">
